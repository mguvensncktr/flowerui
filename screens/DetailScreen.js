        ...
        <View style={{ height: 60, alignItems: 'center' }}>
            ...
            <View
                style={{
                    ...
                    width: '100%',
                    height: 3,
                    marginTop: SIZES.base, backgroundColor: COLORS.gray
                }}
            ></View>
            <View
                style={{
                    ...
                    width: barPercentage,
                    height: 3,
                    marginTop: SIZES.base, backgroundColor: COLORS.primary
                }}
            ></View>
        </View>
    )
...
const ReqDetail = ({ icon, label, detail }) => {
    return (
